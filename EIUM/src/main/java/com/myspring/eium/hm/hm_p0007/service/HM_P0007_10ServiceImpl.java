...
import com.myspring.eium.hm.hm_p0007.dao.HM_P0007_10DAO;
...
public class HM_P0007_10ServiceImpl implements HM_P0007_10Service {
	@Autowired
	private HM_P0007_10DAO p0007_10DAO;

	@Override
	public List<HM_P0007_10VO> searchList(Map<String, Object> searchMap) throws DataAccessException {
		List<HM_P0007_10VO> list =  p0007_10DAO.searchList(searchMap); 
		return list;
	}
	...
	public void saveData(Map<String, String[]> dataMap, String u) throws DataAccessException {
		...
		for(String str : status) {
			...
			if("I".equals(str)) { // 추가
				p0007_10DAO.insertData(row);
			}else if("U".equals(str)) { // 수정
				p0007_10DAO.updateData(row);
			}else if("D".equals(str)) { // 삭제
				p0007_10DAO.deleteData(row);
			}
			i++;
		}
	}
