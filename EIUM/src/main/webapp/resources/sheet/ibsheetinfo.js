...
//    Grids.;
    ...
    //]]>
//    window["sheetid"].CssImageUrl = "./nar/hodo/";
}
...
//	info.Cols.unshift({"Header":"No","Type":"Seq","Align":"Center","SaveName":"SEQ",Width:50,FitColWidth:0,Hidden:1});
...
////        if(col.Type=="Float" && ( col.Format == "#,##0.00" || col.PointCount == 2 ) ){
////        	FloatTrunc.push( col.SaveName );	
//        }
        
        
		  if(typeof(col.ShowMobile)!="undefined"){
		  		sheet.mobileCol.push({"Col":col["SaveName"]});
		  	}
