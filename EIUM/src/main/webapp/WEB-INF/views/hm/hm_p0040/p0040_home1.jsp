...
<script>
	...
	function doAction(sAction) {
		...
		case "search": // 조회
			...
			mySheet.DoSearch("${contextPath}/hm/p0040/searchList.do", param);
...
<span class="searchBarTitle">사업장</span>
<input type="text" id="site">
<a href="javascript:siteSearch()"><img
			src="${contextPath}/resources/image/icons/icon_plus.png"></a>

<span class="searchBarTitle">부서</span> <input id="department" type="text" > <a href="javascript:departmentSearch()"><img src="${contextPath}/resources/image/icons/icon_plus.png"></a>
</div>
