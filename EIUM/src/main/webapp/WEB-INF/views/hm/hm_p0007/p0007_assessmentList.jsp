...
function LoadPage(){
	...
	mySheet2.DoSearch("${contextPath}/hm/p0007/assessment_List.do")
...
function mySheet2_OnDblClick(Row, Col, Value) { 
	...
	var rowData=mySheet2.GetRowData(Row);
	 ...
	 window.opener.assessmentValue(rowData);
...
<body onload="LoadPage()">
	...
	<input type="hidden" id="Cassessment_code">
	<input type="hidden" id="Cassessment_name">
