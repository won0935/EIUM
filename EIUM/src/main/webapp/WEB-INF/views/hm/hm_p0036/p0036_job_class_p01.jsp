...
function LoadPage(){
	...
	initSheet.Cols=[
		...
		{Header:"직종이름",Type:"Text",Width:100,SaveName:"job_CLASS_NAME",Align:"Center"},
	...
	mySheet2.DoSearch("${contextPath}/hm/p0036/searchList_p01.do")
...
function mySheet2_OnDblClick(Row, Col, Value) { 
	 ...
	 window.opener.job_class(rowData);
