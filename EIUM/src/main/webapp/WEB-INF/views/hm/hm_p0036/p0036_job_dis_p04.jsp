...
function LoadPage(){
	...
	initSheet.Cols=[
		...
		{Header:"직책코드",Type:"Text",Width:100,SaveName:"job_DIS_CODE",Align:"Center"},
		{Header:"직책이름",Type:"Text",Width:100,SaveName:"job_DIS_NAME",Align:"Center"},
	...
	mySheet2.DoSearch("${contextPath}/hm/p0036/searchList_p04.do")
