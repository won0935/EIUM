...
function LoadPage(){
	...
	initSheet.Cols=[
		...
		{Header:"직책코드",Type:"Text",Width:100,SaveName:"duty_CODE",Align:"Center"},
		{Header:"직책이름",Type:"Text",Width:100,SaveName:"duty_NAME",Align:"Center"},
	...
	mySheet2.DoSearch("${contextPath}/hm/p0036/searchList_p03.do")
