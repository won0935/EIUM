...
function LoadPage(){
	...
	initSheet.Cols=[
		...
		{Header:"고용형태코드",Type:"Text",Width:100,SaveName:"work_TYPE_CODE",Align:"Center"},
		{Header:"고용형태이름",Type:"Text",Width:100,SaveName:"work_TYPE_NAME",Align:"Center"},
	...
	mySheet2.DoSearch("${contextPath}/hm/p0036/searchList_p05.do")
...
function mySheet2_OnDblClick(Row, Col, Value) { 
	 ...
	 window.opener.work_type(rowData);
